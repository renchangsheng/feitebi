...
public class GoogleAuthenticator {
	...
	/**
	 * @param secretKey
	 *            Base32 encoded secret key (may have optional whitespace)
	 * @param account
	 *            The user's account name. e.g. an email address or a username
	 * @param issuer
	 *            The organization managing this account
	 * @return
	 *
	...
	public static void createQRCode(String barCodeData, String filePath, int height, int width) throws IOException {
	...
	public static void main(String[] args) throws Exception {
		// required for generating the PNG file on a server with no graphics
		// hardware
		System.setProperty("java.awt.headless", "true");

		String secretKey = getRandomSecretKey();
		String barCode = getGoogleAuthenticatorBarCode(secretKey, "BitDash.net", "BitDash");
